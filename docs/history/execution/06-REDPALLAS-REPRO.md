...
```text
path: $HOME/.zecsafe/runs/p0-002-20260711T041846Z/message.txt
bytes: 56
...
```text
path: $HOME/.zecsafe/runs/p0-002-20260711T041846Z/public-key-package.json
bytes: 573
...
```text
path: $HOME/.zecsafe/runs/p0-002-20260711T041846Z/signature-attempt2.raw
bytes: 64
...
```bash
openssl genrsa -out $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.key.pem 2048
openssl req -x509 -new -nodes -key $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.key.pem -sha256 -days 1 -subj '/CN=ZecSafe P0-002 Local CA' -out $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.cert.pem -addext 'basicConstraints=critical,CA:TRUE' -addext 'keyUsage=critical,keyCertSign,cRLSign'
openssl genrsa -out $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.key.pem 2048
openssl req -new -key $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.key.pem -subj '/CN=localhost' -out $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.csr.pem -addext 'subjectAltName=IP:127.0.0.1,DNS:localhost'
openssl x509 -req -in $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.csr.pem -CA $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.cert.pem -CAkey $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.key.pem -CAcreateserial -out $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.cert.pem -days 1 -sha256 -extfile $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.ext
```

Config and group setup:

```bash
cargo run --locked -p frost-client -- init -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/alice.toml
cargo run --locked -p frost-client -- init -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/bob.toml
cargo run --locked -p frost-client -- init -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/eve.toml
cargo run --locked -p frost-client -- trusted-dealer -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/alice.toml -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/bob.toml -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/eve.toml -d 'ZecSafe P0-002 RedPallas 2-of-3' -N Alice,Bob,Eve -s 127.0.0.1:2746 -C redpallas -t 2 -n 3
```

Signing run:

```bash
cargo run --locked -p frostd -- --ip 127.0.0.1 --port 2746 --tls-cert $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.cert.pem --tls-key $HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/server.key.pem
SSL_CERT_FILE=$HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.cert.pem cargo run --locked -p frost-client -- coordinator -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/alice.toml -g faa9ced198abf00043ab8fc7e2092f9311076c4f4cd0108e06a276b20302ad28 -S 00c8aa42673fa3a78265ec6e04fc7acdca310eb2f91e7043cbb943239650c50b,ba6d22b5c90aecb0d388f178ad130fd65d6bca40b78cb9fa6657b8aa52e8e12c -m $HOME/.zecsafe/runs/p0-002-20260711T041846Z/message.txt -o $HOME/.zecsafe/runs/p0-002-20260711T041846Z/signature-attempt2.raw
printf 'y\n' | SSL_CERT_FILE=$HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.cert.pem cargo run --locked -p frost-client -- participant -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/alice.toml -g faa9ced198abf00043ab8fc7e2092f9311076c4f4cd0108e06a276b20302ad28
printf 'y\n' | SSL_CERT_FILE=$HOME/.zecsafe/runs/p0-002-20260711T041846Z/tls/ca.cert.pem cargo run --locked -p frost-client -- participant -c $HOME/.zecsafe/runs/p0-002-20260711T041846Z/configs/bob.toml -g faa9ced198abf00043ab8fc7e2092f9311076c4f4cd0108e06a276b20302ad28
```
...
Raw signature written to $HOME/.zecsafe/runs/p0-002-20260711T041846Z/signature-attempt2.raw
```
...
These files remain outside the repository under `$HOME/.zecsafe/runs/p0-002-20260711T041846Z`.
