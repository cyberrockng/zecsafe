...
| No participant secret share in coordinator workspace | **PASS** — shares live only in `$HOME/.zecsafe/runs/p0-021/configs/`, gitignored, and were **not read** by this audit |
...
| Local private | full intent, recipient, amount, memo, full PCZT, UFVK, wallet DB | `$HOME/.zecsafe/runs/` — outside Git ✅ |
