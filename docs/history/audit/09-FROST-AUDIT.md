...
| Secret material outside repo | YES | `$HOME/.zecsafe/runs/p0-021/configs/*.toml`, gitignored; zero secrets in Git history |
...
```text
$HOME/.zecsafe/runs/p0-021-.../configs/{alice,bob,eve}.toml     ← 3 distinct configs
$HOME/.zecsafe/runs/p0-021-.../contacts/{alice,bob,eve}.contact ← 3 distinct contacts
