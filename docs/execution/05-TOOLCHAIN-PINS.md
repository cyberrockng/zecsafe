...
```bash
git clone https://github.com/ZcashFoundation/frost-tools.git /home/dell/.zecsafe/toolchain/frost-tools
git clone https://github.com/ZcashFoundation/frost.git /home/dell/.zecsafe/toolchain/frost
git clone https://github.com/zcash/zcash-devtool.git /home/dell/.zecsafe/toolchain/zcash-devtool
```

Pinned checkout verification:

```bash
git -C /home/dell/.zecsafe/toolchain/frost-tools rev-parse HEAD
git -C /home/dell/.zecsafe/toolchain/frost rev-parse HEAD
git -C /home/dell/.zecsafe/toolchain/zcash-devtool rev-parse HEAD
```
