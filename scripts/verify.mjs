...
const checks = [
  ...
  [vercelConfig.rewrites?.some((route) => route.source === "/proof" && route.destination === "/index.html"), "Vercel routes /proof to the static proof app"],
  ...
  [readme.includes("https://zecsafe.vercel.app/") && readme.includes("https://zecsafe.vercel.app/proof"), "README links the production routes"],
  ...
  [(await readFile("SUBMISSION.md", "utf8")).includes("https://zecsafe.vercel.app/") && (await readFile("SUBMISSION.md", "utf8")).includes("https://zecsafe.vercel.app/proof"), "submission file links the production routes"],
