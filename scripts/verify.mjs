...
const checks = [
  ...
  [(await readFile("docs/execution/03-CLAIM-TO-CODE-MATRIX.md", "utf8")).includes("C-010"), "Claim matrix includes production/audit claim guard"],
  [(await readFile("docs/execution/12-SUBMISSION-GATE.md", "utf8")).includes("NO-GO - P0 BLOCKERS REMAIN"), "Submission gate records current external blockers"],
